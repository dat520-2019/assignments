...
1. [Introduction](https://github.com/uis-dat520/labs/blob/master/lab1/README.md#introduction)
2. [Lab Overview](https://github.com/uis-dat520/labs/blob/master/lab1/README.md#lab-overview)
3. [Prerequisites](https://github.com/uis-dat520/labs/blob/master/lab1/README.md#prerequisites)
4. [Go Assignments](https://github.com/uis-dat520/labs/blob/master/lab1/README.md#go-assignments)
5. [Lab Approval](https://github.com/uis-dat520/labs/blob/master/lab1/README.md#lab-approval)
...
found at http://github.com/uis-dat520.
...
2. To get started with the Go part of this lab, you can now use the `go get`
   ...
   the command line enter: `go get github.com/uis-dat520/labs` (ignore the
...
3. Change directory to: `cd $GOPATH/src/github.com/uis-dat520/labs`. Next, run
   ...
   https://github.com/uis-dat520/username-labs` where `username` should be
...
5. Note to advanced users: Follow these
   [steps](https://github.com/uis-dat520/course-info/blob/master/github-ssh.md)
...
9. In the following, we will use **Task 1** as an example. Change directory to:
   `cd $GOPATH/src/github.com/uis-dat520/labs/lab1` and confirm that the files
...
15. Running the last command above will, due to an error on our part, result in
    ...
    error: failed to push some refs to 'git@github.com:uis-dat520/username-labs.git'
    ...
...
Policy](https://github.com/uis-dat520/course-info/policy.md)
